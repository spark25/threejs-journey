...
const doorAOccTexture = textureLoader.load(
...
const envMap = textureLoader.load("./textures/environmentMap/2k.hdr");
...
// material.map = doorColorTexture;
// material.aoMap = doorAOccTexture;
...
const tick = () => {
  ...
  tourus.rotation.x = 0.1 * elapsedTime;
